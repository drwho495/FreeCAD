...
if (OpenCASCADE_FOUND)
    ...
    if (WIN32)
        ...
        find_path(OCC_INCLUDE_DIR Standard_Version.hxx
                /home/hypocritical/OCCT_Fork/OCCT/build/install/include/opencascade
                # /usr/include/occt
                # /usr/include/opencascade
                # /usr/local/include/opencascade
                # /opt/opencascade/include
        ...
        find_library(OCC_LIBRARY TKernel
                /home/hypocritical/OCCT_Fork/OCCT/build/install/lib
                # /usr/lib
                # /usr/local/lib
                # /opt/opencascade/lib
        )
...
# if (OpenCASCADE_FOUND)
#     set(OCC_FOUND ${OpenCASCADE_FOUND})
#     set(OCC_INCLUDE_DIR /home/hypocritical/OCCT_Fork/OCCT/build/install/include/opencascade/)
#     set(OCC_LIBRARY_DIR /home/hypocritical/OCCT_Fork/OCCT/build/install/lib/)
#     set(OCC_LIBRARIES ${OpenCASCADE_LIBRARIES})
#     set(OCC_OCAF_LIBRARIES TKCAF TKXCAF)
# else ()
#     if (WIN32)
...
#         #         # /opt/opencascade/lib
#         # )
#         set(OCC_LIBRARY /home/hypocritical/OCCT_Fork/OCCT/build/install/lib/libTKernel.so)
#     endif ()
#     if (OCC_LIBRARY)
#         get_filename_component(OCC_LIBRARY_DIR ${OCC_LIBRARY} PATH)
#         if (NOT OCC_INCLUDE_DIR)
...
#     message(STATUS "Found OpenCASCADE version: ${OCC_VERSION_STRING}")
#     message(STATUS "  OpenCASCADE include directory: ${OCC_INCLUDE_DIR}")
#     message(STATUS "  OCC Library: ${OCC_LIBRARY}")
#     message(STATUS "  OpenCASCADE shared libraries directory: ${OCC_LIBRARY_DIR}")
# endif ()
